...
def mainOfMiniterm(default_port=None, default_baudrate=19200, default_rts=None, default_dtr=None, serial_instance=None, default_String = 'Hello Rutik MTP is DONE!!!' ):
